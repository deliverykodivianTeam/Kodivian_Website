    ...
    return (
        <div className="contact-page-wrapper">
            ...
            <div className="contact-hero-section position-relative d-flex mt-5 align-items-center text-white py-5">
                <div className="hero-background-overlay"></div> {/* Added for gradient */}
                <Container className="position-relative z-1"> {/* Added z-1 to bring content to front */}
                    <Row className="justify-content-center align-items-center g-4">
                        {/* LEFT SIDE: Image */}
                        <Col md={12} lg={7} className="text-center"> {/* Adjusted lg size */}
                            <img
                                src={contact}
                        ...
                        <Col md={12} lg={5}> {/* Adjusted lg size */}
                            <div className="hero-contact-info fade-up">
                                <h1 className="display-4 fw-bold mb-3">Contact Us</h1>
                                <p className="lead mb-4">
                                    Feel free to use the form below or drop us an email. Old-fashioned phone
                                    calls work too! We'd love to hear from you.
                                </p>
                                ...
                                <div className="d-flex align-items-start mb-3">
                                    ...
                                    <span>Kodivian Technologies, 13, Rajamannar St, T. Nagar, Chennai, Tamil Nadu 600017</span>
                                </div>
            ...
            <div className="demo-booking-section bg-light p-5 text-center">
                <Button
                    // No need to change this class if you want specific styles for it,
                    // but ensure its styles in CSS are correct or use Bootstrap's primary button if preferred.
                    className="demo-booking-button px-4 py-2 fw-semibold"
                    onClick={() => alert('Demo booking initiated! (Link to your booking system)')}
                >
                    Book a Free Demo
                </Button>
                <div className="demo-button-info mt-2">
                    Limited slots available. <strong>Book your personalized demo today!</strong>
                </div>
            </div>
            ...
            <Container className="py-5">
                ...
                <Row className="justify-content-center gap-5 gx-md-5">
                    {/* Contact Form Column */}
                    <Col lg={4} className="contact-form-container bg-light p-4 shadow-sm rounded-3"> {/* Adjusted lg size */}
                        <h2 className="text-center fw-bold mb-4 text-dark-purple">Send Us a Message</h2>
                        <p className="text-center mb-4 text-secondary-purple">We'd love to hear from you! Please fill out the form below.</p>
                    ...
                    {/* Map Section Column */}
                    <Col lg={7} className="contact-map p-4 shadow-sm rounded-3"> {/* Adjusted lg size */}
                        <h2 className="text-center fw-bold mb-4 text-dark-purple">Our Locations</h2>
                        <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap"> {/* Added flex-wrap for small screens */}
                            <Form.Group controlId="locationSelect" className="mb-0 flex-grow-1 me-md-3 mb-3 mb-md-0"> {/* Adjusted for better spacing */}
                                <Form.Label className="me-2 text-dark-purple fw-bold">SELECT LOCATION :</Form.Label>
                                <Form.Select value={selectedLocationId} onChange={handleLocationChange} className="location-select-dropdown">
                        ...
                        <div className="map-container rounded-3 overflow-hidden mb-3">
                            {currentMapEmbedUrl ? (
                                ...
                                <div className="map-placeholder d-flex align-items-center justify-content-center bg-light-purple text-secondary-purple rounded-3" style={{ height: '450px' }}>
                                    <p>Loading map...</p>
                                </div>
                            )}
                        </div>
                        {currentLocation && (
                            <Card className="location-details-card mt-3 border-0 bg-light-purple text-dark-purple">
                                <Card.Body>
                                    <Card.Title className="fw-bold">{currentLocation.name}</Card.Title>
                                    <Card.Text>
