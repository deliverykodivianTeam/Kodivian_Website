...
const Product = () => {
  ...
  useEffect(() => {
    if (inView) {
      ...
      if (sampleImage) {
        sampleImage.classList.add("animate-move-up-down");
      }
    } else {
      // Optionally remove the class if it goes out of view and triggerOnce is false
      const sampleImage = document.querySelector(".sample-image");
      if (sampleImage && !inView) {
        sampleImage.classList.remove("animate-move-up-down");
      }
    }
  }, [inView]);
  ...
  return (
    <div>
      <div className="hero-section">
        <div className="hero-content">
          ...
          <div className="absolute" style={{ width: "100%" }}>
            ...
            <h1 className="hero-title">
              Work <br /> smarter, <br /> finish faster
            </h1>
            <p className="hero-description">
              Take control of your tasks, automate workflows and stay focused
              with our all-in-one AI-driven platform.
            </p>
        ...
        <div className="sample-section" ref={ref}>
          {" "}
          ...
          <div className="sample-content">
            <h2 className="sample-title">
              Conquering Your Invoicing Challenges with Scanify
            </h2>
            <p className="sample-description">
              Scanify is a powerful solution designed to simplify your invoice
              management process. It scans invoices with high accuracy,
              automatically extracts key data, and converts it into structured
              JSON and Excel formats. This data can be seamlessly pushed into
              SAP for efficient processing, eliminating the need for manual
              entry and reducing the risk of errors.Whether you're handling a
              few invoices or managing high volumes, Scanify scales with your
              business, helping you stay organized, compliant, and in control.
            </p>
            <Link to="/scanify" className="sample-button">
              {" "}
              Explore features{" "}
            </Link>
          </div>
        ...
        <div className="sample2-section">
          <div className="sample2-content">
            <h2 className="sample3-title">
              {" "}
              Turn Processes Into Powerful Applications with Process Builder
            </h2>
            <p className="sample3-description">
              Process Builder empowers you to create fully functional workflows
              and forms using an intuitive drag-and-drop interface—no coding
              required. In just seconds, you can design custom applications,
              assign them to specific clients or users, and instantly generate
              user pages, dashboards, reports, and charts. Whether you're
              automating internal processes or building client-facing solutions,
              Process Builder makes it incredibly easy, fast, and efficient.
              Bring your ideas to life and streamline your operations like never
              before.
            </p>
            <Link to="/processbuilder" className="sample-button">
              {" "}
              Explore features{" "}
            </Link>
          </div>
        ...
        <div className="sample1-section">
          ...
          <div className="sample1-content">
            <h2 className="sample2-title">
              Automating Repetitive Tasks with RPA
            </h2>
            <p className="sample2-description">
              Our RPA (Robotic Process Automation) solution is built to handle
              repetitive, rule-based tasks with speed and precision. Whether
              it's data entry, report generation, or invoice processing, RPA
              takes over these time-consuming processes and executes them
              automatically—no manual effort required. Just set the schedule,
              and RPA performs the task on time, every time, reducing human
              error and freeing up valuable manpower. It's the perfect tool for
              businesses looking to boost productivity, cut operational costs,
              and focus on strategic growth.
            </p>
            <Link to="/robort" className="sample-button">
              {" "}
              Explore features{" "}
            </Link>
          </div>
        ...
        <div className="sample3-section">
          <div className="sample3-content">
            <h2 className="sample1-title">
              Smarter Document Management with IntelliDoc
            </h2>
            <p className="sample1-description">
              IntelliDoc is your all-in-one solution for smart document handling
              and automation. It allows you to manage, process, and organize
              documents .With IntelliDoc, you can assign signature marks, apply
              approval status watermarks, and automate every step required for
              document completion. Whether you're managing contracts, invoices,
              or internal approvals, IntelliDoc ensures each file is processed
              accurately and moves through the workflow without delays. Say
              goodbye to manual follow-ups and hello to seamless, scheduled
              document automation.
            </p>
            <Link to="/document" className="sample-button">
              {" "}
              Explore features{" "}
            </Link>
          </div>
